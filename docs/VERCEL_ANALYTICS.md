...
Choose the instructions below based on your framework or project type:
...
For more information and detailed API documentation, visit the [Vercel Analytics documentation](https://vercel.com/docs/analytics).
